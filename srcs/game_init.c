...
/*   Updated: 2025/03/28 11:17:07 by mcarton          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if (tile == '1')
        return (mlx_put_image_to_window(game->mlx, game->win, game->wall,
        x * 32, y * 32));
    if (tile == '0')
        return (mlx_put_image_to_window(game->mlx, game->win, game->floor,
        x * 32, y * 32));
    if (tile == 'P')
        return (mlx_put_image_to_window(game->mlx, game->win, game->player,
        x * 32, y * 32));
    if (tile == 'C')
        return (mlx_put_image_to_window(game->mlx, game->win, game->collect,
        x * 32, y * 32));
    if (tile == 'E')
        return (mlx_put_image_to_window(game->mlx, game->win, game->exit,
        x * 32, y * 32));
    return (0);
}
